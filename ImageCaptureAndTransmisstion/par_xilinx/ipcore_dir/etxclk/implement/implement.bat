...
xst -ifn xst.scr
move etxclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\etxclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc etxclk_exdes.ucf etxclk_exdes

echo 'Running map'
map -timing -pr b etxclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm etxclk_exdes -w routed.ncd routed.v
cd ..
